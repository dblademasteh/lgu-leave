...
import { Landmark, LayoutDashboard, CalendarDays, CheckSquare, BarChart3, Settings as SettingsIcon } from 'lucide-react';
    ...
    <div className={`flex items-center gap-3 px-4 py-3 border-b border-line ${expanded ? '' : 'justify-center'}`}>
      ...
      {expanded && (
        <div className="min-w-0">
          <p className="font-display font-bold text-ink leading-tight truncate">LGU Leave</p>
    ...
    <>
      ...
      {mobileOpen && (
        <div className="fixed inset-0 z-50 md:hidden" role="dialog" aria-modal="true">
          <button type="button" className="absolute inset-0 bg-ink/50 backdrop-blur-sm" onClick={onMobileClose} aria-label="Close navigation" tabIndex={-1} />
